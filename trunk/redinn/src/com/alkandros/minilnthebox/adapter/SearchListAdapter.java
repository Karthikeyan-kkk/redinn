...
public class SearchListAdapter extends ArrayAdapter<SlideNavigationModel> {
	...
	public SearchListAdapter(Context context, 
			ArrayList<SlideNavigationModel> objects) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final SlideNavigationModel rowItem = getItem(position);
